...
if Syndicator then
	addonTable.Constants.KeywordGroupOrder = Syndicator.Search.Constants.KeywordGroupOrder
		or {
	...
	addonTable.Constants.SampleSearchTerms = {
		...
		Syndicator.Locales.KEYWORD_GEAR
			...
			.. Syndicator.Locales.KEYWORD_SOULBOUND
			.. "&"
			.. Syndicator.Locales.KEYWORD_JUNK,
...
addonTable.Constants.ContainerKeyToInfo = {
	...
	keyring = {
		type = "file",
		value = "interface\\addons\\baganator\\assets\\bag_keys",
		tooltipHeader = addonTable.Locales.KEYS,
	},
	[0] = nil, -- regular bag
	[1] = {
		type = "file",
		value = "interface\\addons\\baganator\\assets\\bag_soul_shard",
		tooltipHeader = addonTable.Locales.SOUL,
	}, -- soulbag
